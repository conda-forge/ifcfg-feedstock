...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ifcfg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8091&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ifcfg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ifcfg` can be installed with:

```
conda install ifcfg
```

It is possible to list all of the versions of `ifcfg` available on your platform with:
